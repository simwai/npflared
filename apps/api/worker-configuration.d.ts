/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 67d54c8eca894b8a264da6603f144f8d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		BUCKET: string;
		DB: string;
		FALLBACK_REGISTRY_POINT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FALLBACK_REGISTRY_ENDPOINT" | "D1_DATABASE_ID" | "D1_DATABASE_NAME" | "BUCKET" | "DB" | "FALLBACK_REGISTRY_POINT" | "NODIST_PREFIX">> {}
}
