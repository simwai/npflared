# Token Scopes and Management

Tokens are the cryptographic trust-signals that allow you to interact with the Npflared registry. Managing these is key to maintaining a secure and functional node in your private package ecosystem.
